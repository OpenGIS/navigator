...
Replace the path with the spec that covers the feature you are working on.
...
E2E specs live in `tests/e2e/` and test application behaviour directly. Each spec covers a logical area of the app (e.g. core UI, locate feature, settings).

---

## Screenshots

Screenshots are captured by Playwright and embedded in documentation. They live in `tests/e2e/screenshots/`.

| Screenshot spec                        | Output                               | Used in     |
| -------------------------------------- | ------------------------------------ | ----------- |
| `tests/e2e/screenshots/readme.spec.js` | `assets/screenshots/app-preview.png` | `README.md` |

To regenerate a screenshot spec:
...
tests/
  ...
  e2e/
    ...
    features/
      locate.spec.js         ← GPS locate feature
