...
Navigator uses a composable ([`useStorage`](https://github.com/OpenGIS/navigator/blob/master/src/composables/useStorage.js) to persist state to `localStorage`. Keys follow the pattern:
