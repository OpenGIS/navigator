...
When designing a plugin, keep it self-contained following the conventions in [docs/dev/features.md](../dev/features.md): composable in `src/composables/`, panel in `src/components/panels/`, button in `src/components/ui/top/`.
