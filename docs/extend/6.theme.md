...
> [!TIP]
> Ready-to-use theme files [here](https://github.com/OpenGIS/navigator/tree/master/docs/extend/examples/theme/). Each file is a complete, standalone SCSS theme — copy it into your project and import it as described above.

### Green (`examples/theme/green.scss`)
...
1. Copy `examples/theme/green.scss` into your project (e.g. `src/green-theme.scss`).
