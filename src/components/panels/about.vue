...
<template>
  <div class="navigator-about-panel d-flex flex-column flex-grow-1">
    <div class="sidebar-section sidebar-section-body p-3 pb-0">
      <h5 class="mb-0">{{ t('about.title') }}</h5>
    </div>
    ...
    <div class="sidebar-section sidebar-section-body p-3 border-top">
      ...
      <div class="d-flex flex-column gap-3">
        <div class="d-flex align-items-center">
          <span class="badge bg-danger bg-opacity-10 text-danger rounded-pill me-2">Map Data</span>
          <a
        ...
        <div class="d-flex align-items-center">
          <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill me-2">Tile Hosting</span>
          <a
        ...
        <div class="d-flex align-items-center">
          <span class="badge bg-success bg-opacity-10 text-success rounded-pill me-2">User Interface</span>
